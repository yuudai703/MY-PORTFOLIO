  ...
  currentUrl.indexOf('blog/create')==-1){
    ...
    <div class="AboutMe">
      ...
      <h1>AboutMe</h1>
          ...
          <p>hobby：筋トレ　サウナ</p>
          <br>
          <p class="aboutMeP" style="width: 80%; white-space:normal;" class="text-gray-600">22歳の時、未経験で都内ITベンチャー企業でセキュリティ会社のスマートフォンアプリのテスターや
          医療用システム、一般住宅のWi-Fiシステムのテクニカルサポートを経験、
          現在は地元長野県の企業でLaravelをメインとした販売管理システムの受託開発と保守運用、自社用の勤怠管理システムの開発など、
          業務用システムの開発に従事しております。
          </p>
      </div>
    ...
    <h1 class="cv-title" style=" margin-left: 30%; " margin-bottom: -30%;">Resume / CV</h1>
      ...
      <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto" _msthidden="3">
        ...
        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row" _msthidden="2">
          <div class="flex-grow sm:pl-6 mt-6 sm:mt-0" _msthidden="2">
            ...
            IT業界に興味を持ち始め22歳の時思い切って都内の社員数30名、平均年齢20代のベンチャー企業へ転職。
